        ...
        void Filter()
        {
            using (UnitOfWork db = new UnitOfWork())
            {
                ...
                if ((int)cbCustomer.SelectedValue != 0)
                {
                    ...
                    result.AddRange(db.AccountingRepository.Get(a => a.TypeID == TypeID && a.CustomersID == customerId));
                }
                else
                {
                ...
                {
                    string customerName = db.CustomerRepository.GetCustomerNameById(accounting.CustomersID);
